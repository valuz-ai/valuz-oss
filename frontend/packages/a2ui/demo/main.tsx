...
const surfaces = [
  makeSurface(
    ...
    [
      ...
      { id: "tags", component: "TagBlock", tags: [{ label: "A2UI v0.9.1", tone: "brand" }, { label: "43 components", tone: "success" }, { label: "Strict schemas", tone: "info" }] },
      ...
      { id: "table", component: "Table", caption: "Renderer quality gates", striped: true, columns: [{ key: "gate", label: "Gate" }, { key: "scope", label: "Scope" }, { key: "status", label: "Status", align: "right" }], rows: [{ gate: "Schema", scope: "43 APIs", status: "Passed" }, { gate: "Interaction", scope: "Actions + bindings", status: "Passed" }, { gate: "Visual", scope: "Light + dark", status: "Review" }] },
    ],
    {},
  ),
  makeSurface(
  ...
  makeSurface(
    ...
    [
      ...
      { id: "pie", component: "PieChart", title: "Donut chart", data: { path: "/mix" }, nameKey: "name", valueKey: "value", height: 240 },
